...
def conv(t: Tensor,
    ...
    Args:
        ...
        weight (Tensor):
            ...
            of channels, kD, kH and kW are the depth, height and width of the kernel, M is the number of feature maps.
        stride (Tuple[int]):
        ...
        pad_type (PadType(default is not_set)):
            pad_type must be either not_set, same_upper, same_lower or valid. Where default value is not_set, which means explicit
            ...
            odd). In the case the padding is an odd number, the extra padding is added at the end for same_upper and at the beginning for
            same_lower.
        ...
        enable_conv_dithering (List[int]):
            Enable convolution dithering per convolution. If true, then convolutions with different parameters will be laid out from
