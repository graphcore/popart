...
PYBIND11_MODULE(popart_opset10, m) {
  py::class_<AiOnnxOpset10>(m, "AiOnnxOpset10")
      ...
      .def(
          ...
          py::arg("args"),
          py::arg("debugContext") = std::string(),
          DOC(popart, logical_and, opset10))
      .def(
          "logical_and",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("debugContext")      = std::string(),
          DOC(popart, averagepool, opset10))
      .def(
          "averagepool",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("debugContext") = std::string(),
          DOC(popart, batchnormalization, opset10))
      .def(
          "batchnormalization",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("value"),
          py::arg("debugContext") = std::string(),
          DOC(popart, constantofshape, opset10))
      .def(
          "constantofshape",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("strides")      = std::vector<int64_t>(),
          py::arg("debugContext") = std::string(),
          DOC(popart, convinteger, opset10))
      .def(
          "convinteger",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("strides")        = std::vector<int64_t>(),
          py::arg("debugContext")   = std::string(),
          DOC(popart, convtranspose, opset10))
      .def(
          "convtranspose",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("blocksize"),
          py::arg("debugContext") = std::string(),
          DOC(popart, depthtospace, opset10))
      .def(
          "depthtospace",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("args"),
          py::arg("debugContext") = std::string(),
          DOC(popart, dequantizelinear, opset10))
      .def(
          "dequantizelinear",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("args"),
          py::arg("debugContext") = std::string(),
          DOC(popart, globalaveragepool, opset10))
      .def(
          "globalaveragepool",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("p")            = 2,
          py::arg("debugContext") = std::string(),
          DOC(popart, globallppool, opset10))
      .def(
          "globallppool",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("args"),
          py::arg("debugContext") = std::string(),
          DOC(popart, globalmaxpool, opset10))
      .def(
          "globalmaxpool",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("beta")         = 0.5f,
          py::arg("debugContext") = std::string(),
          DOC(popart, hardsigmoid, opset10))
      .def(
          "hardsigmoid",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("epsilon")      = 1e-05f,
          py::arg("debugContext") = std::string(),
          DOC(popart, instancenormalization, opset10))
      .def(
          "instancenormalization",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("p")            = 2,
          py::arg("debugContext") = std::string(),
          DOC(popart, lpnormalization, opset10))
      .def(
          "lpnormalization",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("args"),
          py::arg("debugContext") = std::string(),
          DOC(popart, matmulinteger, opset10))
      .def(
          "matmulinteger",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("debugContext") = std::string(),
          DOC(popart, meanvariancenormalization, opset10))
      .def(
          "meanvariancenormalization",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("debugContext") = std::string(),
          DOC(popart, multinomial, opset10))
      .def(
          "multinomial",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("debugContext")     = std::string(),
          DOC(popart, nonmaxsuppression, opset10))
      .def(
          "nonmaxsuppression",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("args"),
          py::arg("debugContext") = std::string(),
          DOC(popart, logical_not, opset10))
      .def(
          "logical_not",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("strides")      = std::vector<int64_t>(),
          py::arg("debugContext") = std::string(),
          DOC(popart, qlinearconv, opset10))
      .def(
          "qlinearconv",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("args"),
          py::arg("debugContext") = std::string(),
          DOC(popart, qlinearmatmul, opset10))
      .def(
          "qlinearmatmul",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("args"),
          py::arg("debugContext") = std::string(),
          DOC(popart, quantizelinear, opset10))
      .def(
          "quantizelinear",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("seed")         = nonstd::optional<float>(),
          py::arg("debugContext") = std::string(),
          DOC(popart, randomnormal, opset10))
      .def(
          "randomnormal",
          [](AiOnnxOpset10 &opset,
             const std::vector<int64_t> &shape,
      ...
      .def(
          ...
          py::arg("seed")         = nonstd::optional<float>(),
          py::arg("debugContext") = std::string(),
          DOC(popart, randomnormallike, opset10))
      .def(
          "randomnormallike",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("seed")         = nonstd::optional<float>(),
          py::arg("debugContext") = std::string(),
          DOC(popart, randomuniform, opset10))
      .def(
          "randomuniform",
          [](AiOnnxOpset10 &opset,
             const std::vector<int64_t> &shape,
      ...
      .def(
          ...
          py::arg("seed")         = nonstd::optional<float>(),
          py::arg("debugContext") = std::string(),
          DOC(popart, randomuniformlike, opset10))
      .def(
          "randomuniformlike",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("keepdims")     = 1,
          py::arg("debugContext") = std::string(),
          DOC(popart, reducelogsum, opset10))
      .def(
          "reducelogsum",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("keepdims")     = 1,
          py::arg("debugContext") = std::string(),
          DOC(popart, reducelogsumexp, opset10))
      .def(
          "reducelogsumexp",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("keepdims")     = 1,
          py::arg("debugContext") = std::string(),
          DOC(popart, reducesumsquare, opset10))
      .def(
          "reducesumsquare",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("time_axis")    = 0,
          py::arg("debugContext") = std::string(),
          DOC(popart, reversesequence, opset10))
      .def(
          "reversesequence",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("blocksize"),
          py::arg("debugContext") = std::string(),
          DOC(popart, spacetodepth, opset10))
      .def(
          "spacetodepth",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("debugContext")       = std::string(),
          DOC(popart, stringnormalizer, opset10))
      .def(
          "stringnormalizer",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("debugContext") = std::string(),
          DOC(popart, tfidfvectorizer, opset10))
      .def(
          "tfidfvectorizer",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("alpha")        = 1.0f,
          py::arg("debugContext") = std::string(),
          DOC(popart, thresholdedrelu, opset10))
      .def(
          "thresholdedrelu",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
      ...
      .def(
          ...
          py::arg("args"),
          py::arg("debugContext") = std::string(),
          DOC(popart, logical_xor, opset10))
      .def(
          "logical_xor",
          [](AiOnnxOpset10 &opset,
             const std::vector<TensorId> &args,
