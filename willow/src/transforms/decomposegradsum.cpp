...
bool GradPartial::operator<(const GradPartial &other) const {
  ...
  // (pipeline stage, execution phase, batch serialized phase)
  ...
  std::tuple<PipelineStage, ExecutionPhase, BatchSerializedPhase, size_t> order(
  ...
  std::tuple<PipelineStage, ExecutionPhase, BatchSerializedPhase, size_t>
      otherOrder(otherOp->hasPipelineStage() ? otherOp->getPipelineStage()
                                             : unusedPipelineStage,
                 otherOp->hasExecutionPhase() ? otherOp->getExecutionPhase()
