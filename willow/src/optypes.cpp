...
OpTypes::OpTypes() {
  ...
  opTypes_ = {
      ...
      {std::make_pair("BatchNormalization", ai_onnx),
       OpTypeInfo(OpType::BATCHNORM, true)},
      {std::make_pair("BatchNormalizationGrad", ai_graphcore),
       OpTypeInfo(OpType::BATCHNORMGRAD, false)},
      ...
      {std::make_pair("Reshape", ai_onnx), OpTypeInfo(OpType::RESHAPE, true)},
      {std::make_pair("ReshapeGrad", ai_graphcore),
       OpTypeInfo(OpType::RESHAPEGRAD, false)},
      {std::make_pair("Sigmoid", ai_onnx), OpTypeInfo(OpType::SIGMOID, true)},
      {std::make_pair("SigmoidGrad", ai_graphcore),
       OpTypeInfo(OpType::SIGMOIDGRAD, false)},
      ...
      {std::make_pair("Subsample", ai_graphcore),
       OpTypeInfo(OpType::SUBSAMPLE, true)},
      {std::make_pair("SubsampleGrad", ai_graphcore),
       OpTypeInfo(OpType::SUBSAMPLEGRAD, false)},
      ...
      {std::make_pair("Transpose", ai_onnx),
       OpTypeInfo(OpType::TRANSPOSE, true)},
      {std::make_pair("TransposeGrad", ai_graphcore),
       OpTypeInfo(OpType::TRANSPOSEGRAD, false)}};
