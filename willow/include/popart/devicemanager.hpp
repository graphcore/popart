...
public:
  ...
  /// Log an event for device debugging purposes. This event will get logged
  /// to the file location set by evironment variable POPART_DEVICE_ACCESS_LOG,
  /// if it is set.
  /// \param event A textual description of the device event.
  /// \param auxKeyVals Additional parameters to log.
