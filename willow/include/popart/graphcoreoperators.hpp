...
const static AiGraphcoreOpIdV1 GeluErfGrad("GeluErfGrad");
...
const static AiGraphcoreOpIdV1 TiedGatherGrad("TiedGatherGrad");
...
const static AiGraphcoreOpIdV1 CastThenPow2Scale("CastThenPow2Scale", 2, 1);
const static AiGraphcoreOpIdV1 Pow2ScaleThenCast("Pow2ScaleThenCast", 2, 1);
...
const static AiGraphcoreOpIdV1 DynamicSlice_1("DynamicSlice", {2, 3}, 1);
const static AiGraphcoreOpIdV1
    DynamicSliceInplace_1("DynamicSliceInplace", 3, 1);
...
const static AiGraphcoreOpIdV1 GeluErf_1("GeluErf", 1, 1);
const static AiGraphcoreOpIdV1 GeluErfInplace("GeluErfInplace");
...
const static AiGraphcoreOpIdV1 RemoteCodeLoad("RemoteCodeLoad", {0, 0}, 0);
...
const static AiGraphcoreOpIdV1 ScatterReduce("ScatterReduce", {2, 3}, 1);
...
const static AiGraphcoreOpIdV1 SGD1Nesterov("SGD1Nesterov");
...
const static OperatorIdentifier CastThenPow2Scale =
    CustomOperators::CastThenPow2Scale;
const static OperatorIdentifier Pow2ScaleThenCast =
    CustomOperators::Pow2ScaleThenCast;
...
const static OperatorIdentifier DynamicSliceInplace =
    CustomOperators::DynamicSliceInplace_1;
...
const static OperatorIdentifier GeluErf     = CustomOperators::GeluErf_1;
