...
#define __OPSET6_EXPAND(x) x
#define __OPSET6_COUNT(_1, _2, _3, _4, _5, _6, _7, COUNT, ...) COUNT
#define __OPSET6_VA_SIZE(...)                                                  \
  __OPSET6_EXPAND(__OPSET6_COUNT(__VA_ARGS__, 7, 6, 5, 4, 3, 2, 1))
#define __OPSET6_CAT1(a, b) a##b
#define __OPSET6_CAT2(a, b) __OPSET6_CAT1(a, b)
#define __OPSET6_DOC1(n1) __doc_##n1
#define __OPSET6_DOC2(n1, n2) __doc_##n1##_##n2
#define __OPSET6_DOC3(n1, n2, n3) __doc_##n1##_##n2##_##n3
#define __OPSET6_DOC4(n1, n2, n3, n4) __doc_##n1##_##n2##_##n3##_##n4
#define __OPSET6_DOC5(n1, n2, n3, n4, n5) __doc_##n1##_##n2##_##n3##_##n4##_##n5
#define __OPSET6_DOC6(n1, n2, n3, n4, n5, n6)                                  \
  __doc_##n1##_##n2##_##n3##_##n4##_##n5##_##n6
#define __OPSET6_DOC7(n1, n2, n3, n4, n5, n6, n7)                              \
  __doc_##n1##_##n2##_##n3##_##n4##_##n5##_##n6##_##n7
#define OPSET6_DOC(...)                                                        \
  __OPSET6_EXPAND(__OPSET6_EXPAND(__OPSET6_CAT2(                               \
      __OPSET6_DOC, __OPSET6_VA_SIZE(__VA_ARGS__)))(__VA_ARGS__))
