...
public:
  ElementWiseUnaryOp(const OpConstructorBundle &);
  ElementWiseUnaryOp(const onnx::NodeProto &node, Ir *pir);
...
public:
  ElementWiseNonLinearUnaryGradOp(const OpConstructorBundle &);
