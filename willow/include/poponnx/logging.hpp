...
/// This is a simple logging system for Poplar based on spdlog. The easiest
...
/// variables, eg
/// POPLAR_LOG_LEVEL=ERR
/// POPLAR_LOG_DEST=Mylog.txt
///
...
// log level is set by the POPLAR_LOG_LEVEL environment variable
