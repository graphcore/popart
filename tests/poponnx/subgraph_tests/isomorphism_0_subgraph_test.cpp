...
BOOST_AUTO_TEST_CASE(Isomorphism0_Subgraph) {
  ...
  // -----------------------------------------------
  poponnx::logging::info("no edges test");
  ...
  // ----------------------------------------------------------
  poponnx::logging::info("isomorphism preserving edges test");
  ...
  // ----------------------------------------------------------
  poponnx::logging::info("differing input indices test");
  ...
  // ----------------------------------------------------------
  poponnx::logging::info("internal vs external input test");
  ...
  // -------------------------------------------------------------------
  poponnx::logging::info("isomorphically different external input test");
  // in this test, the [123]s are not isomporphic as one has
  // an internal input to 3, the other has an external input
  ...
  // --------------------------------------------------------------------------
  poponnx::logging::info("isomorphically different external output index test");
  // in this test, the [123]s are not isomporphic as one has
  // an internal input to 3, the other has an external input
  ...
  // --------------------------------------------------------------------------
  poponnx::logging::info("four isomorphically equivalent");
