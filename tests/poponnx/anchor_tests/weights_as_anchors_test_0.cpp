...
BOOST_AUTO_TEST_CASE(WeightAnchorTest0) {
  ...
  poponnx::NDArrayWrapper<float> input1_wrapper(v_input_0.data(), stepDataInfo);
  ...
  poponnx::NDArrayWrapper<float> w1_wrapper(v_w1_out.data(), stepWeightShape);

  std::vector<float> v_w2_out(stepWeightElms, -77.0f);
  poponnx::NDArrayWrapper<float> w2_wrapper(v_w2_out.data(), stepWeightShape);

  std::vector<float> v_w3_out(stepWeightElms, -77.0f);
  poponnx::NDArrayWrapper<float> w3_wrapper(v_w3_out.data(), stepWeightShape);

  std::vector<float> v_w4_out(stepWeightElms, -77.0f);
  poponnx::NDArrayWrapper<float> w4_wrapper(v_w4_out.data(), stepWeightShape);

  std::vector<float> v_w5_out(stepWeightElms, -77.0f);
  poponnx::NDArrayWrapper<float> w5_wrapper(v_w5_out.data(), stepWeightShape);
