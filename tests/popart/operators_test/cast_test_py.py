...
def test_cast_grad(op_tester, npSrcType, torchDstType, builderDstType):
    """Check that CastOp, does return gradient Op when casted-from type is
    float/half.
    """
...
@pytest.mark.parametrize("npSrcType,torchDstType,builderDstType", [
    ...
    (np.int16, torch.float32, "FLOAT"),
    (np.int32, torch.float32, "FLOAT"),
    (np.uint8, torch.float32, "FLOAT"),
    (np.uint16, torch.float32, "FLOAT"),
    (np.uint32, torch.float32, "FLOAT"),
    (np.int8, torch.float16, "FLOAT16"),
    (np.int16, torch.float16, "FLOAT16"),
    (np.int32, torch.float16, "FLOAT16"),
    (np.uint8, torch.float16, "FLOAT16"),
    (np.uint16, torch.float16, "FLOAT16"),
    (np.uint32, torch.float16, "FLOAT16"),
])
def test_cast_no_grad(op_tester, npSrcType, torchDstType, builderDstType):
