...
BOOST_AUTO_TEST_CASE(AliasZeroCopyLoopTest0) {
  ...
  reference.emplace_back(OpStatus::Enter, 0); // LoopOp
  ...
  reference.emplace_back(OpStatus::Normal, 0);          // AddOp (iteration 1)
  reference.emplace_back(OpStatus::CopyOutput, 0);      // staId -> tcId
  reference.emplace_back(OpStatus::CopyOutput, 1);      // stdId -> tdId
  reference.emplace_back(OpStatus::Exit, 0);            // LoopOp
