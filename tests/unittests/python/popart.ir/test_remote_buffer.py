...
from popart.ir.remote_buffer import RemoteBuffer, remote_buffer
...
def standard_remote_buffer(
    ...
    standard_remote_buffer = RemoteBuffer(ir=pir.Ir(),
...
class TestRemoteBuffer:
    ...
    def test_set_remote_buffer_info(
        ...
        remote_buffer_2 = RemoteBuffer(ir=pir.Ir(),
                                       tensor_shape=t_shape,
                                       tensor_dtype=t_dtype,
                                       entries=entries)
