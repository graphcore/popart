...
from streamingmemory_test_0 import run_model, check_model, onChipLocation, offChipLocation, offChipRtsLocation, onChipRtsLocation
...
def test_pipelined_streaming_rmsprop(tmpdir):
    ...
    optimizer = popart.Adaptive(optimizer_dict, popart.AdaptiveMode.RMSProp,
