...
def get_ir(
    ...
    with tu.create_test_device(
        ...
        if accumulator_tensor_location_settings is not None:
            opts.accumulatorTensorLocationSettings = (
                accumulator_tensor_location_settings
            )
        ...
        for i in range(num_iterations):
            ip_data = np.random.rand(
                num_replicas, accumulation_factor, batch_size, dsize, dsize
            ).astype(np.float32)
...
def test_activation_tensor_location_settings():
    ...
    check_ir(ir, check_onchip=["MatMul:0/1__t6", "MatMul:0__t3"], check_offchip=[])
    ...
    check_ir(ir, check_onchip=[], check_offchip=["MatMul:0/1__t6", "MatMul:0__t3"])
...
def test_activation_tensor_location_settings_plus_override():
    ...
    ir = get_ir(
        ...
        tensor_location_setting_override={
            "MatMul:0/1__t6": popart.TensorLocation(popart.TensorStorage.OnChip)
        },
    )
    check_ir(ir, check_onchip=["MatMul:0/1__t6"], check_offchip=["MatMul:0__t3"])
    ...
    ir = get_ir(
        ...
        tensor_location_setting_override={
            "MatMul:0/1__t6": popart.TensorLocation(popart.TensorStorage.OffChip)
        },
    )
    check_ir(ir, check_onchip=["MatMul:0__t3"], check_offchip=["MatMul:0/1__t6"])
...
def test_accumulator_tensor_location_settings():
    ...
    ir = get_ir(
        accumulator_tensor_location_settings=None, optimizer=optimizer_with_state
    )
    check_ir(ir, check_onchip=["Accl___W1", "Accl___W2", "Accl___W0"], check_offchip=[])
    ...
    check_ir(ir, check_onchip=[], check_offchip=["Accl___W1", "Accl___W2", "Accl___W0"])
...
def test_accumulator_tensor_location_settings_plus_override():
    ...
    check_ir(ir, check_onchip=["Accl___W1"], check_offchip=["Accl___W2", "Accl___W0"])
    ...
    check_ir(ir, check_onchip=["Accl___W2", "Accl___W0"], check_offchip=["Accl___W1"])
