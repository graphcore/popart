...
def serial_inference_model(ir: popxl.Ir, stream_input_shape: Tuple[int],
    ...
    with main:
        ...
        hidden_weights = popxl.variable(weights_and_biases["hidden_weights"],
                                        name="hidden_weights")
        hidden_bias = popxl.variable(weights_and_biases["hidden_bias"],
                                     name="hidden_bias")
        output_weights = popxl.variable(weights_and_biases["output_weights"],
                                        name="output_weights")
        output_bias = popxl.variable(weights_and_biases["output_bias"],
                                     name="output_bias")
        ...
        t_in_h2d = popxl.h2d_stream(stream_input_shape,
                                    popxl.float32,
                                    name="t_in_stream")
        t_out_d2h = popxl.d2h_stream(output_bias.shape,
                                     popxl.float32,
                                     name="t_out_stream")
