...
def test_average_pool_1_auto_pad(op_tester):
    ...
    def reference(_):  # ref_data is an unused argument
        out = pool(padded, x_shape, kernel_shape, strides, out_shape, [0], "AVG")
...
def test_average_pool_2_auto_pad(op_tester):
    ...
    def reference(_):  # ref_data is an unused argument
        out = pool(padded, x_shape, kernel_shape, strides, out_shape, [0, 0], "AVG")
...
def test_average_pool_3_auto_pad(op_tester):
    ...
    def init_builder(builder):
        i1 = builder.addInputTensor(x)
        o = builder.aiOnnx.averagepool(
            [i1], kernel_shape=kernel_shape, auto_pad="SAME_UPPER", strides=strides
        )
        builder.addOutputTensor(o)
        return [o]
    ...
    def reference(_):  # ref_data is an unused argument
        ...
        out = pool(padded, x_shape, kernel_shape, strides, out_shape, pad_shape, "AVG")
...
def test_average_pool_4_auto_pad(op_tester):
    ...
    def init_builder(builder):
        i1 = builder.addInputTensor(x)
        o = builder.aiOnnx.averagepool(
            [i1], kernel_shape=kernel_shape, auto_pad="SAME_LOWER", strides=strides
        )
        builder.addOutputTensor(o)
        return [o]
...
def test_max_pool_1_auto_pad(op_tester):
    ...
    def reference(_):  # ref_data is an unused argument
        out = np.array([[[[7, 9, 10], [17, 19, 20], [22, 24, 25]]]]).astype(np.float32)
...
def test_max_pool_2_auto_pad(op_tester):
    ...
    def reference(_):  # ref_data is an unused argument
        ...
        out = pool(padded, x_shape, kernel_shape, strides, out_shape, pad_shape, "MAX")
