...
FIND_LIBRARY(POPSYS_LIB
  NAMES popsys
  HINTS ${POPLAR_INSTALL_DIR}/poplibs/lib ${POPLAR_INSTALL_DIR}/lib
  PATH_SUFFIXES poplibs poplibs/lib
  DOC "popsys library to link to")
IF(NOT POPSYS_LIB)
  MESSAGE(FATAL_ERROR "Could not set POPSYS_LIB. ${WhatToDoString}")
ENDIF()
MESSAGE(STATUS "Found POPRAND_LIB ${POPSYS_LIB}")
MARK_AS_ADVANCED(POPSYS_LIB)
