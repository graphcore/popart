...
MESSAGE(STATUS "found cblas header ${CBLAS_INCLUDE_DIRS} (for fast cpu gemm)")
...
MESSAGE(STATUS "found cblas library ${CBLAS_LIBRARIES} (for fast cpu gemm)")
...
if(NOT CBLAS_INCLUDE_DIRS)
  message(FATAL_ERROR "Could NOT find 'cblas.h', install a CPU Netlib BLAS or set CBLAS_ROOT")
endif()
if(NOT CBLAS_LIBRARIES)
  message(FATAL_ERROR "Could NOT find a CPU Netlib BLAS library, install it or set CBLAS_ROOT")
endif()
