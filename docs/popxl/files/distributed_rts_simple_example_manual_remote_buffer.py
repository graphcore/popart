...
with ir.main_graph:
    remote_buffer = popxl.replica_sharded_buffer((2,), popxl.dtypes.int)
    v_handle = popxl.remote_replica_sharded_variable([1, 1], 0, remote_buffer)
    v_shard = ops.remote_load(remote_buffer, 0)
    ...
    ops.remote_store(v_shard, remote_buffer, 0)
