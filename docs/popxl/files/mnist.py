...
def build_train_ir(
    ...
    with ir.main_graph, popxl.in_sequence():
        ...
        outputs, params, linears, fwd_call_infos = create_network_fwd_graph(ir, x)
        # loss begin
...
def build_test_ir(
    ...
    with ir.main_graph, popxl.in_sequence():
        ...
        # Build forward pass graph
        outputs, params, _, _ = create_network_fwd_graph(ir, x)
...
def main() -> None:
    ...
    parser.add_argument(
        "--test-batch-size", type=int, default=80, help="batch size for testing"
    )
    parser.add_argument(
