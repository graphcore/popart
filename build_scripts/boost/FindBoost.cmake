#################### GRAPHCORE MODIFICATIONS ######################

# This file is copied from CMake 35bfc85d95a480f0b0b6f22d764e06672cd8d6ac
# (between CMake 3.14 and 3.15), because you need a recent FindBoost.cmake
# for old versions of CMake to find boost. However we don't want to risk
# it accidentally finding the system boost so we set some options to try
# to prevent that.

# Don't use Boost CMake, which might search in system locations.
set(Boost_NO_BOOST_CMAKE TRUE)
# Don't search system paths.
set(Boost_NO_SYSTEM_PATHS TRUE)
# Provide a hint where to find boost, although this is not strictly necessary
# since CBT adds this directory to the CMAKE_PREFIX_PATH anyway.
set(BOOST_ROOT "${CMAKE_CURRENT_LIST_DIR}/../..")

# Also the code around CMake policy 0093 and FindPackageHandleStandardArgs
# has been changed to work with older versions of CMake.
